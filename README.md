...
+ 교육
  ...
  - 멋쟁이사자처럼 AI스쿨 : 2021.08 ~ 11(약 3개월)
+ 대회
  - Dacon 가스공급량 수요예측 모델개발
    - 기간 : 2021.10.11 ~ 12.10 23:00
    - 역할 : 📢부팀장(총 3명)
    - 성과 : ✨22등(총 488명 중) 기록. 🥇 멋쟁이사자처럼 교육 코스 내 최고의 팀 프로젝트 선정
  - Dacon 잡케어 추천 알고리즘 경진대회
    - 기간 : 2021.12.06 (19:00) ~ 2022.01.28
    - 역할 : 📢팀장(총 3명)
    - 성과 : ✨189등(총 1,335명), 상위 26% 기록
  - Dacon 주식 종료 가격 예측 경진대회
...
+ 기간 : 2025.07.01 ~ 
+ 업무
  + ai 기반 펩타이드-단백질 결합 후보 예측 시스템 구축 MVP [[상세내용]](https://github.com/kbjung/Study/tree/main/graduate_school/peptide_binding_mvp)
  + ai 시스템 구축 [[상세내용]](https://github.com/kbjung/Study/blob/main/graduate_school/rcsb)
  + 공부 [[상세내용]](https://github.com/kbjung/Study/blob/main/graduate_school/study)
...
+ 팀프로젝트2 [[상세내용]](https://github.com/kbjung/LikeLion_13th_DataCourse/tree/main/TP02#readme)
  ...
  - 성과 : 🥇 13회차 교육 코스 내 최고의 팀 프로젝트 선정. ✨ 22등(총 488명 중) 기록.
